...
namespace XOR_Genetyczny
{
    class XOR_Genetyczny
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Najlepszy: {0}, Średnia: {1}",najlepszy_osobnik.Item2, Srednia(oceny));
            ...
            for (int i = 0; i < liczba_iteracji; i++)
            {
                ...
                Console.WriteLine("Najlepszy: {0}, Średnia: {1}",najlepszy_osobnik.Item2, Srednia(oceny_now));
                oceny = oceny_now;
            }

            Console.WriteLine("Najlepszy osobnik: {0}, Przystosowanie: {1}", najlepszy_osobnik.Item1, najlepszy_osobnik.Item2);
        }
    }
}
